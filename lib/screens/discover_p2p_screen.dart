    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: GoogleFonts.inter(fontSize: ScreenService.isTablet ? 26 : 24, color: Color(0xffffffff), fontWeight: FontWeight.w600),
        ),
        15.vSpace,
        Text(
          "This list will refresh in 43s",
          style: GoogleFonts.inter(fontSize: ScreenService.isTablet ? 18 : 16, color: Color(0xffffffff), fontWeight: FontWeight.w500),
        ),
        10.vSpace,
        Text(
          "Bank Transfer",
          style: GoogleFonts.inter(fontSize: ScreenService.isTablet ? 16 : 14, color: Color(0xffffffff), fontWeight: FontWeight.w500),
        ),
        20.vSpace,
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Container(
                    height: ScreenService.isTablet ? 50.h : 30.h,
                    width: ScreenService.isTablet ? 50.h : 30.w,
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    "BTC",
                    style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.w600, fontSize: ScreenService.isTablet ? 16 : 14),
                  ),
                  5.hSpace,
                  Icon(
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            width: ScreenService.isTablet ? 15.h : 20.w,
                            decoration: BoxDecoration(
                              color: Colors.white,
